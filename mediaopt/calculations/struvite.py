"""struvite precipitation risk - NOT YET PORTED.
...
Reference implementation: the 'struvite' worksheet of the workbook.
"""


def saturation_index(*args, **kwargs):
    raise NotImplementedError(
        "struvite saturation index is not yet ported from the workbook (Phase 6). "
